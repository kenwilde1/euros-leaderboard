...
const calculateTopGoalScorers = (topGoalscorer, res, scores, pos, previousScores, index, lengthOfResults) => {
...
export const fetchTally = (results, goalScorers) => {
   ...
   results.forEach((result, index) => {
    ...
    results.forEach((res, index) => {
        calculateTopGoalScorers(hughPredictions.topGoalscorer, res, scores, 0, previousScores, index, lengthOfResults);
        calculateTopGoalScorers(philipPredictions.topGoalscorer, res, scores, 1, previousScores, index, lengthOfResults);
        calculateTopGoalScorers(stephenPredictions.topGoalscorer, res, scores, 2, previousScores, index, lengthOfResults);
        calculateTopGoalScorers(shanePredictions.topGoalscorer, res, scores, 3, previousScores, index, lengthOfResults);
        calculateTopGoalScorers(alanPredictions.topGoalscorer, res, scores, 4, previousScores, index, lengthOfResults);
        calculateTopGoalScorers(dylWPredictions.topGoalscorer, res, scores, 5, previousScores, index, lengthOfResults);
        calculateTopGoalScorers(kennyPredictions.topGoalscorer, res, scores, 6, previousScores, index, lengthOfResults);
